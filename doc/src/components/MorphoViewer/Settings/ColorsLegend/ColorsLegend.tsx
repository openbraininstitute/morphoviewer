...
export function ColorsLegend({ className, painter }: ColorsLegendProps) {
    ...
    useEffect(() => {
        ...
        return () =>
            painter.eventColorsChange.removeListener(handleColorChange);
    }, [painter]);
    ...
    return (
        <div className={classNames(styles.main, className)}>
            ...
            <button
                ...
                onClick={handleReset}
            >
                <IconReset className={styles.icon} />
...
function getProperLabels(painter: MorphologyCanvas): Partial<Labels> {
    ...
    if (painter.hasBasalDendrite()) {
        output.colorBasalDendrite = labels.colorBasalDendrite;
    }
    if (painter.hasApicalDendrite()) {
        output.colorApicalDendrite = labels.colorApicalDendrite;
    }
...
function getCorrectLabelsVersionDependingOnDendrites(
    painter: MorphologyCanvas,
): Labels {
