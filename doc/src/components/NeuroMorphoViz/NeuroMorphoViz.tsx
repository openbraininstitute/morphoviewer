...
export function NeuroMorphoViz({ className, swc }: NeuroMorphoVizProps) {
  ...
  return (
    <div className={classNames(styles.main, className)}>
      ...
      <section>
        <InputText label="Service address:" value={server} onChange={setServer} />
        <InputText label="Token:" value={token} onChange={setToken} />
        <InputText label="TextId:" value={fileId} onChange={setFileId} />
        <InputText label="orgLabel:" value={orgLabel} onChange={setOrgLabel} />
        <InputText label="projectLabel:" value={projectLabel} onChange={setProjectLabel} />
      ...
      <p>
        ...
        <a href="https://staging.nise.bbp.epfl.ch/nexus" target="_blank">
          here
        </a>
...
async function queryNeuroMorphoVizSoma({
  ...
  if (!resp.ok) {
    ...
    throw Error(`Error #${resp.status} in process-soma endpoint: ${resp.statusText}!`);
  }
