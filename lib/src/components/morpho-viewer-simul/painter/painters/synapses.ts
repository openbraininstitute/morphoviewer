...
function computePositionOnSphereSurface(
	...
	const result: ArrayNumber3 = [
		x + 2 * r * R * Math.cos(lng),
		y + 2 * r * R * Math.sin(lng),
		z + 2 * r * Z,
	];
	console.log("🐞 [synapses@141] x, y, z, r =", x, y, z, r); // @FIXME: Remove this line written on 2026-02-25 at 15:51
	console.log("🐞 [synapses@136] result =", result); // @FIXME: Remove this line written on 2026-02-25 at 15:50
	return result;
}
